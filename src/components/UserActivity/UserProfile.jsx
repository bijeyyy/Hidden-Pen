...
function UserProfile() {
  ...
  useEffect(() => {
    const getUserProfile = async () => {
      ...
      setProfile({
        fullName: metadata.display_name || metadata.name || "",
        username: metadata.username || "",
        email: user.email || "",
        phone: metadata.phone || "",
        avatarUrl: metadata.avatar_url || metadata.picture || "",
        hiddenLink: `${window.location.origin}/u/${user.id}`,
      });
    ...
    <div className="min-h-screen bg-bg px-6 py-10">
      <div className="max-w-3xl mx-auto bg-card border border-default rounded-base shadow-xs p-6">
        ...
        <div className="mt-8 border-t border-default pt-6 space-y-3">
          ...
          <div className="bg-white dark:bg-neutral-900 border border-default rounded-base p-3">
          ...
          <button
            ...
            className="bg-button hover:bg-button-hover text-white px-4 py-2 rounded-base"
          >
