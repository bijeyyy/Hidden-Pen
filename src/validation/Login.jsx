      ...
      <div className="justify-center items-center md:mt-4 mt-18 bg-neutral-primary-soft block w-82 p-6 border border-default rounded-base shadow-xs">
        ...
        <form onSubmit={handleEmailLogin} className="grid gap-4">
          <div className="grid gap-1">
            ...
            <input
              ...
              className="p-2 border border-gray-200 rounded-md text-xs"
              required
            />
          </div>
          ...
          <div className="flex justify-end">
            <Link to="/forgot_password" className="text-xs text-center text-blue-500 hover:underline">
              forgot password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full text-white bg-button border-transparent box-border border hover:bg-button-hover hover:text-white shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
          >
        ...
        <div>
          <button
            ...
            className="flex items-center w-full text-black bg-transparent box-border border border-gray-300 hover:bg-gray-100 shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
          >
